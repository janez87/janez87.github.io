...
In collaboration with the [Stem Cell & Brain Research Institute (SBRI)](https://sbri.fr) at Lyon 1, this project applies time series clustering and sub-sequence matching techniques to neural activity signals, with the goal of characterizing behavioral patterns from LFP recordings.
