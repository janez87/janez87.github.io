...
My current work spans three main directions:

- **[Human-Centric Graph Data Management](/research/graph-repairs)** — interactive and user-driven approaches to graph database repair, query formulation, and causal analysis.
- **[Crowdsourcing and Human-in-the-Loop Systems](/research/crowdsourcing)** — quality-aware human-in-the-loop algorithms for data collection, integration, and analysis.
- **[Empathy-Centric Design](/research/empathy-design)** — tools and methods for embedding empathy into participatory design and policy-making.

I hold a PhD from [Politecnico di Milano](https://www.polimi.it), where I developed methodologies for crowd and social-based application design.
